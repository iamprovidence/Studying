...
{
    public class FileQueryHandler : IQueryHandler<FileContentQuery, IEnumerable<WorkerData>>, IUnitOfWorkSettable, IMapperSettable
    {
        ...
        void IMapperSettable.SetMapper(IMapper mapper)
        {
        }
